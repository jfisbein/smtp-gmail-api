...
public class GmailAPI {
  ...
  public GmailAPI(File credentialsFile) throws GeneralSecurityException, IOException {
   ...
   */
  private static Credential getCredentials(NetHttpTransport httpTransport, File credentialsFile) throws IOException {
    // Load client secrets.
   ...
   */
  public static MimeMessage createEmail(String to, String from, String subject, String body) throws MessagingException {
  ...
  public Message sendMessage(String to, String from, String subject, String bodyText) throws MessagingException, IOException {
    return sendMessage(createEmail(to, from, subject, bodyText));
  }

  public static void main(String... args) throws IOException, GeneralSecurityException, MessagingException {
    GmailAPI gmail = new GmailAPI(new File("src/main/resources/credentials.json"));
    gmail.sendMessage("jfisbein@gmx.com", "joan@fisbein.com", "Test Email " + new Date(), "Hola <b>Caracola</b>");
  }
}